...
export const DisplayCenterCard = React.memo(({ card }) => {
    ...
    return (
        <div className='flex justify-center p-4 rounded-xl items-center border-2 gap-2 w-full xl:flex-row flex-col h-fit xl:h-82 snap-center'>
            <DisplayCard card={card} />
            <div className='w-full xl:w-1/3 min-h-80 rounded-2xl overflow-hidden border-2 relative group bg-cover bg-center bg-no-repeat'
            ...
            <div className='w-full xl:w-1/3 h-full min-h-80 border-2 rounded-2xl relative'>
